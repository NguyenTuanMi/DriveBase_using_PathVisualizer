...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    ...
    // set the kinematics for the trajectory config
    Trajectory trajectory = TrajectoryGenerator.generateTrajectory( 
      // create the trajectory, we can use list of point (the below code) 
      //or import a path generated by the Pathweaver (the below comments)
